...
function asyncUpVoteDetailThread({ threadId, isDownVoted }) {
  return async (dispatch, getState) => {
    ...
    dispatch(
      neutralVoteDetailThreadActionCreator({ userId, target: "down-vote" }),
    );
    ...
    try {
      ...
      dispatch(
        neutralVoteDetailThreadActionCreator({ userId, target: "up-vote" }),
      );
...
function asyncNeutralVoteComment({ commentId, target }) {
  return async (dispatch, getState) => {
    ...
    dispatch(
      neutralVoteCommentActionCreator({ commentId, userId: id, target }),
    );
